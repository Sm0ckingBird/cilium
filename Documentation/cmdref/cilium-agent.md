...
```
      ...
      --bpf-lb-dsr-dispatch string                           BPF load balancing DSR dispatch method ("opt", "ipip", "ipipv4cni") (default "opt")
      ...
      --conntrack-gc-max-interval duration                   Set the maximum interval for the connection-tracking garbage collection (default 30m0s)
  ...
  -D, --debug                                                Enable debugging mode
      ...
      --enable-xdp-chain                                     Enable XDP Chain, i.e: multiple XDP
